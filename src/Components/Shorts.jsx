                        ...
                        short.prod_category === "shorts" ? <Box w='auto'
                            ...
                            <Box>
                                ...
                                >
                                    ...
                                    >
                                        <Tooltip hasArrow
                                            label={splitProdId?.includes(short._id) ? "Added" : "Add to wishlist"}
                                            mt={2}>
                                            <Box onClick={() => handleAddAndRemoveWishlist(short._id)}>
                                                {
                                                    splitProdId?.includes(short._id) ? <BsSuitHeartFill
                                                        color={"red"}
